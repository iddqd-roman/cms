...
use Yii;
use yii\cms\modules\page\models\Page as PageModel;
use yii\helpers\Html;
use yii\web\NotFoundHttpException;

/**
 * Page module API
 * @package yii\cms\modules\page\api
 *
 * @method static PageObject get(mixed $id_slug) Get page object by id or slug
 */

class Page extends \yii\cms\components\API
{
    private $_pages = [];
    ...
    private function notFound($id_slug)
    {
        ...
        if(IS_ROOT && preg_match(PageModel::$SLUG_PATTERN, $id_slug)){
            $config['title'] = $config['text'] = Html::a(Yii::t('cms/page/api', 'Create page'), ['/admin/page/a/create', 'slug' => $id_slug], ['target' => '_blank']);
        } else {
